...
<div class="squeart-container">
	...
	<div class="squart-option <?php if($url=='downloads'): ?>active<?php endif; ?>">
	...
	<div class="squart-option <?php if($url=='customer-logout'): ?>active<?php endif; ?>">
...
<div id="learndash_profile" style="overflow: scroll;">
